...
extern "C" {
  ...
  void* tree_sitter_tlapp_external_scanner_create() {
    return new Scanner();
  }

  // Called once parser is deleted or different language set.
  // Frees memory storing scanner state.
  void tree_sitter_tlapp_external_scanner_destroy(void* const payload) {
  ...
  unsigned tree_sitter_tlapp_external_scanner_serialize(
    void* const payload,
    char* const buffer
  ) {
  ...
  void tree_sitter_tlapp_external_scanner_deserialize(
    void* const payload,
  ...
  // Scans for tokens.
  bool tree_sitter_tlapp_external_scanner_scan(
    void* const payload,
    TSLexer* const lexer,
    const bool* const valid_symbols
  ) {
